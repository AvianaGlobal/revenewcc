...
def xref_update(supplier_crossref_list):
    ...
    supplier_crossref_list.to_pickle('ranking/inputdata/crossref.pkl')
...
def comm_update(commodity_list):
    ...
    commodity_list.to_pickle('ranking/inputdata/commodities.pkl')
...
def scard_update(supplier_scorecard):
    ...
    supplier_scorecard.to_pickle('ranking/inputdata/scorecard.pkl')
...
def scard_read():
    ...
    supplier_scorecard = pd.read_csv('ranking/inputdata/scorecard.csv')
